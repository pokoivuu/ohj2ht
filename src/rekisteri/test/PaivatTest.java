 ...
 * @version 2021.04.22 17:40:51 // Generated by ComTest
 *
 */
...
public class PaivatTest {
   ...
   */
  @Test
  public void testPoista130() throws SailoException {    // Paivat: 130
    Paivat paivat = new Paivat(); 
    ...
    assertEquals("From: Paivat line: 137", 1, paivat.poista(id1+1)); 
    assertEquals("From: Paivat line: 138", null, paivat.annaId(id1+1)); assertEquals("From: Paivat line: 138", 2, paivat.getLkm()); 
    assertEquals("From: Paivat line: 139", 1, paivat.poista(id1)); assertEquals("From: Paivat line: 139", 1, paivat.getLkm()); 
    assertEquals("From: Paivat line: 140", 0, paivat.poista(id1+3)); assertEquals("From: Paivat line: 140", 1, paivat.getLkm()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testLueTiedostosta158 
   * @throws SailoException when error
   */
  @Test
  public void testLueTiedostosta158() throws SailoException {    // Paivat: 158
    Paivat paivat = new Paivat(); 
    ...
    fail("Paivat: 173 Did not throw SailoException");
    ...
    assertEquals("From: Paivat line: 180", maanantai1, i.next()); 
    assertEquals("From: Paivat line: 181", maanantai2, i.next()); 
    assertEquals("From: Paivat line: 182", false, i.hasNext()); 
    paivat.lisaa(maanantai2); 
    paivat.tallenna(); 
    assertEquals("From: Paivat line: 185", true, ftied.delete()); 
    File fbak = new File(tiedostoNimi+".bak"); 
    assertEquals("From: Paivat line: 187", true, fbak.delete()); 
    assertEquals("From: Paivat line: 188", true, dir.delete()); 
  } // Generated by ComTest END
 ...
 * @throws SailoException */
  @Test
  public void testEtsi372() throws SailoException {    // Paivat: 372
    Paivat paivat = new Paivat(); 
    ...
    assertEquals("From: Paivat line: 385", 3, loytyneet.size()); 
    assertEquals("From: Paivat line: 386", true, loytyneet.get(0) == paiva4); 
    assertEquals("From: Paivat line: 387", true, loytyneet.get(1) == paiva1); 
    assertEquals("From: Paivat line: 388", true, loytyneet.get(2) == paiva3); 
    loytyneet = (List<Paiva>)paivat.etsi("*Pal*",1); 
    assertEquals("From: Paivat line: 391", 1, loytyneet.size()); 
    assertEquals("From: Paivat line: 392", true, loytyneet.get(0) == paiva3); 
    loytyneet = (List<Paiva>)paivat.etsi(null,-1); 
    assertEquals("From: Paivat line: 396", 5, loytyneet.size()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testAnnaId416() throws SailoException {    // Paivat: 416
    Paivat paivat = new Paivat(); 
    Paiva maa1 = new Paiva(), maa2 = new Paiva(), maa3 = new Paiva(); 
    maa1.rekisteroi(); maa2.rekisteroi(); maa3.rekisteroi(); 
    int id1 = maa1.getTunnusNro(); 
    paivat.lisaa(maa1); paivat.lisaa(maa2); paivat.lisaa(maa3); 
    assertEquals("From: Paivat line: 423", true, paivat.annaId(id1  ) == maa1); 
    assertEquals("From: Paivat line: 424", true, paivat.annaId(id1+1) == maa2); 
    assertEquals("From: Paivat line: 425", true, paivat.annaId(id1+2) == maa3); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testEtsiId439() throws SailoException {    // Paivat: 439
    Paivat paivat = new Paivat(); 
    Paiva maa1 = new Paiva(), maa2 = new Paiva(), maa3 = new Paiva(); 
    maa1.rekisteroi(); maa2.rekisteroi(); maa3.rekisteroi(); 
    int id1 = maa1.getTunnusNro(); 
    paivat.lisaa(maa1); paivat.lisaa(maa2); paivat.lisaa(maa3); 
    assertEquals("From: Paivat line: 446", 1, paivat.etsiId(id1+1)); 
    assertEquals("From: Paivat line: 447", 2, paivat.etsiId(id1+2)); 
  } // Generated by ComTest END
}